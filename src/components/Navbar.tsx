          ...
          <div className={styles.profileDropdown} ref={profileRef}>
            ...
            <div className={styles.profileMenu}>
              <a href="#" className={styles.profileMenuItem} onClick={(e) => { e.preventDefault(); handleProfileMenuClick('个人设置'); }}>
                <span className={styles.profileMenuIcon}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 01-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg></span>
                <span>个人设置</span>
              </a>
              <a href="#" className={styles.profileMenuItem} onClick={(e) => { e.preventDefault(); handleProfileMenuClick('修改密码'); }}>
                <span className={styles.profileMenuIcon}><svg width="16" height="16" viewBox="-2 -4 28 28" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path className={styles.lockShackle} d="M7 11V7a5 5 0 0110 0v4"/></svg></span>
                <span>修改密码</span>
              </a>
              <a href="#" className={styles.profileMenuItem} onClick={(e) => { e.preventDefault(); handleProfileMenuClick('退出登录'); }}>
                <span className={styles.profileMenuIcon}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><g className={styles.logoutGroup}><line x1="21" y1="12" x2="9" y2="12"/><polyline points="16 17 21 12 16 7"/></g></svg></span>
                <span>退出登录</span>
              </a>
            </div>
          </div>
